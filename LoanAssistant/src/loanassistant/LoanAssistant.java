/**
Project 1 :- Loan Assistant
 */
package loanassistant;
/**
 * @author Rittik Pradhan
 */
import javax.swing.*;
import java.awt.*;
...
JTextField balanceTextField = new JTextField(); JLabel interestLabel =
new JLabel();
JTextField interestTextField = new JTextField(); JLabel monthsLabel =
new JLabel();
JTextField monthsTextField = new JTextField(); JLabel paymentLabel =
new JLabel();
...
JTextArea analysisTextArea = new JTextArea(); JButton exitButton =
new JButton();
Font myFont = new Font("Arial", Font.PLAIN, 16); Color lightYellow =
new Color(255, 255, 128); boolean computePayment;
...
analysisTextArea.setBackground(Color.WHITE); gridConstraints =
new GridBagConstraints(); gridConstraints.gridx = 3;
gridConstraints.gridy = 1;
...
- getHeight())), getWidth(), getHeight());paymentButton.doClick();}
...
payment =
Double.valueOf(paymentTextField.getText()).doubleValue(); if (payment
...
Double.valueOf(paymentTextField.getText()).doubleValue(); // showanalysis 
